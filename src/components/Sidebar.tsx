...
import Logo from '../images/logo/deco.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 pr-6 pl-6 pt-6 pb-0 ">
        <NavLink to="/">
          <div
            className='flex items-center gap-1.5 text-white flex-row'
          >
            <img src={Logo} alt="Logo"
              className="w-20 h-20"
            />
            <p className='text-white text-bold text-title-lg'>DCash</p>
          </div>
          <div>
            <p className='text-white font-bold text-center'>Seus cashbacks centralizados</p>
          </div>
